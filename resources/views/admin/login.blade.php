...
<body>
    <div class="admin-UI container-fluid d-flex justify-content-center align-items-center p-0">
        <div class="col-md-3 d-flex flex-column">
            ...
            <form name="form-login" method="post" class="form-login-admin" onsubmit="return check()" action="/admin/login">
                @csrf
                <div class="form-group">
                    <label for="email">Tên người dùng hoặc Địa chỉ Email</label>
                    <input type="text" class="form-control" placeholder="Tên hoặc địa chỉ email" name="accountAdmin" id="email-admin">
                </div>
                <div class="form-group">
                    <label for="pwd">Mật khẩu</label>
                    <input type="password" class="form-control" placeholder="Mật khẩu" name="pwAdmin" id="password-admin">
                </div>
                ...
                <button type="submit" class="btn btn-primary" name="submit-login-form">Đăng nhập</button>
                <div id="error" class="mt-3"></div>
            </form>
            <div class="support-pasword  ml-3 mt-2 d-flex flex-column">
                <a href="/admin/verification-email/" class="support-pasword-link mb-1">Bạn quên mật khẩu?</a>
